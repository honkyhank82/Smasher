declare module '@sentry/react-native' {
  ...
  export function captureMessage(message: string, level?: SentryCore.SeverityLevel): string;
  export function configureScope(callback: (scope: SentryCore.Scope) => void): void;
