...
export const API_BASE_URL = 'https://smasher-api.fly.dev'; // Replace with your actual backend URL

// WebSocket URL (for Socket.IO)
export const WS_URL = 'https://smasher-api.fly.dev'; // Same as API_BASE_URL for Socket.IO
