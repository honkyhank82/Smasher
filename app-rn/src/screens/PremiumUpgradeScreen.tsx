    ...
    <ScrollView style={styles.container}>
      ...
      >
        {loading ? (
          ...
          <>
            ...
            <Text style={styles.upgradeButtonSubtext}>$9.99/month • Cancel anytime</Text>
          </>
        )}
      </TouchableOpacity>
      ...
      <View style={styles.termsContainer}>
        <Text style={styles.termsText}>
          By subscribing, you agree to automatic monthly billing. You can cancel anytime from
          Settings. No refunds for partial months. Payment processed securely by Stripe.
        </Text>
      </View>
