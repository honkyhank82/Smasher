    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <Text style={styles.paragraph}>
          By accessing and using SMASHER ("the App"), you accept and agree to be bound
          by the terms and provision of this agreement. If you do not agree to these
          terms, please do not use the App.
        </Text>

        <Text style={styles.sectionTitle}>2. Eligibility</Text>
        <Text style={styles.paragraph}>
          You must be at least 18 years old to use this App. By using the App, you
        ...
        <Text style={styles.paragraph}>
          You retain all rights to the content you upload to the App. By uploading
          content, you grant SMASHER a worldwide, non-exclusive, royalty-free license
        ...
        <Text style={styles.paragraph}>
          In no event shall SMASHER be liable for any indirect, incidental, special,
        ...
        <Text style={styles.paragraph}>
          ...
          through the Help & Support section.
        </Text>
