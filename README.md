...
Copyright 2025 HonkyHankInc. All rights reserved.

### Permitted Use
You are granted a non-exclusive, non-transferable, revocable license to:
- Download and install **Smasher** on your devices.
- Use the software for personal or commercial purposes.

### Prohibited Actions
You may not, under any circumstances:
- Modify, adapt, translate, reverse-engineer, decompile, or disassemble the software.
- Create derivative works based on **Smasher**.
...
### Distribution
Only official releases from this GitHub repository (or HonkyHankInc-approved channels) may be shared.  
Redistribution of the software binaries outside these channels is strictly prohibited.

### Termination
Violation of these terms will result in immediate termination of your license.  
HonkyHankInc reserves the right to pursue legal remedies.
...
Who is it for?  18+ Gay men looking to meet other men to date, or make connections.
...
A: Block them immediately (tap their profile > three dots > Block). Then report them (three dots > Report).
